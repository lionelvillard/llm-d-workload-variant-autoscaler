...
func (g *GreedyBySaturation) filterScaleUpCandidates(decisions []*types.VariantDecision) []*types.VariantDecision {
	var candidates []*types.VariantDecision
...
func (g *GreedyBySaturation) sortByPriority(decisions []*types.VariantDecision) {
...
func (g *GreedyBySaturation) allocateForDecision(d *types.VariantDecision, allocator ResourceAllocator) {
